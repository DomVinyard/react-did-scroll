...
var _supports = __webpack_require__(107);
...
var _reactEventListener = __webpack_require__(50);
...
var ReactOnScroll = function (_React$Component) {
  _inherits(ReactOnScroll, _React$Component);

  function ReactOnScroll() {
    _classCallCheck(this, ReactOnScroll);

    var _this = _possibleConstructorReturn(this, (ReactOnScroll.__proto__ || Object.getPrototypeOf(ReactOnScroll)).call(this));
  ...
  _createClass(ReactOnScroll, [{
    ...
    value: function handleScroll() {
      ...
      var percentPrecision = (h[st] || b[st]) / ((h[sh] || b[sh]) - h.clientHeight) * 100;
      var percent = parseFloat((Math.round(percentPrecision * 100) / 100).toFixed(2));
      this.setState({
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement(_reactEventListener2.default, { target: "window", onScroll: function onScroll() {
